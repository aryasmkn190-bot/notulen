...
import FsLightboxImport from "fslightbox-react";
import Content from "@/layout/content/Content";
import Head from "@/layout/head/Head";
import SliderImport from "react-slick";

// Use a fallback to handle both ESM and CJS environments
const FsLightbox = FsLightboxImport.default || FsLightboxImport;
...
const sliderSettings = {
  className: "slider-init row slick-fullheight",
  slidesToShow: 4,
  centerMode: false,
  slidesToScroll: 1,
  infinite: false,
                ...
                <Row className="g-gs flex-lg-row-reverse pt-5">
                  <Col lg={5}>
                    <div className="video">
                      ...
                      <FsLightbox
                      toggler={videoOpen}
                      sources={['https://www.youtube.com/watch?v=SSo_EIwHSd4']}
                      />
                      <a
