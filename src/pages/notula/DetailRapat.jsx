  ...
  return (
    <React.Fragment>
      ...
      <Content>
            ...
            <BlockHeadContent className="mt-3 mt-md-0">
              <div className="d-flex flex-wrap gap-2">
                ...
                <Button color="primary" size="sm" onClick={openReader}>
                  <Icon name="play-circle" className="me-1" />
              ...
              <Card className="card-bordered">
                <CardBody className="card-inner p-3 p-md-4">
                  <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                    <h6 className="title mb-0 fs-16px">Risalah & Catatan Notulensi</h6>
                  ...
                  <FormGroup className="mb-3">
                    ...
                    <Input
                      ...
                      id="agenda"
                      rows="3"
                      placeholder="Tuliskan poin-poin agenda pembahasan rapat..."
                      value={notes.agenda}
                  ...
                  <FormGroup className="mb-3">
                    ...
                    <Input
                      ...
                      id="catatan"
                      rows="7"
                      placeholder="Catat seluruh jalannya diskusi, dinamika forum, dan arahan pimpinan..."
                      value={notes.catatan}
                  ...
                  <FormGroup className="mb-4">
                    ...
                    <Input
                      ...
                      id="keputusan"
                      rows="4"
                      placeholder="Tuliskan keputusan resmi yang disepakati bersama..."
                              ...
                              >
                                <div className="nk-tb-col">
                                  ...
                                  <span className="sub-text text-muted fs-11px">
                                    Oleh: <strong>{q.penanya || "Anonim"}</strong>
                                    {q.unit ? ` (${q.unit})` : ""} · PIC:{" "}
                                    <strong>{q.pic || "-"}</strong>
                                  </span>
                                </div>
                    ...
                    <CardBody className="card-inner p-3">
                      ...
                      <Form onSubmit={handleAddQ}>
                        ...
                        <Button color="primary" type="submit" className="w-100" size="sm">
                          ...
                          <span>Tambahkan ke Notulensi</span>
                        </Button>
                      </Form>
                    </CardBody>
                  </Card>
          ...
          {activeQ && (
            <>
              <ModalHeader toggle={() => setActiveQ(null)}>
                Detail Pertanyaan & Rencana Tindak Lanjut
              </ModalHeader>
        ...
        {/* FULLSCREEN READER MODE (PROYEKTOR BACAKAN) */}
        {readerOpen && meetingQuestions.length > 0 && (
          <div className="reader-mode-overlay">
            {/* Top Bar */}
            <div className="d-flex justify-content-between align-items-center p-3 border-bottom bg-light">
              <div className="d-flex align-items-center gap-2 text-truncate">
                <span className="badge bg-primary flex-shrink-0">PROYEKTOR FORUM</span>
                <strong className="text-dark text-truncate fs-14px">
                  {meeting.judul}
                </strong>
              </div>
              <div className="d-flex align-items-center gap-2 flex-shrink-0">
                <span className="badge bg-dark fs-12px">
                  {readerIdx + 1} / {meetingQuestions.length}
                </span>
                <Button
                  color="danger"
                  size="sm"
            ...
            {/* Content Slide */}
            <div
              className="flex-grow-1 d-flex align-items-center justify-content-center p-3 p-md-5 overflow-auto"
            >
                  ...
                  return (
                    <div>
                      <div className="d-flex gap-2 mb-3 flex-wrap">
                        <span className="badge bg-primary fs-13px px-2 py-1">
                          {q.kategori}
                        </span>
                        <span className="badge bg-secondary fs-13px px-2 py-1">
                          Prioritas {q.prioritas}
                        </span>
                        <span className="badge bg-info fs-13px px-2 py-1">
                          Status: {q.status.toUpperCase()}
                        </span>
                      </div>

                      <h3
                        className="fw-bold mb-3 text-dark fs-20px fs-md-28px"
                        style={{ lineHeight: 1.4 }}
                      >
                        “{q.teks}”
                      </h3>

                      <h6 className="text-muted fw-normal mb-3 fs-14px">
                        Penanya:{" "}
                      ...
                      <div className="card card-bordered p-3 bg-lighter mb-3">
                        <h6 className="title text-dark mb-2 fs-13px">
                          Rencana Tindak Lanjut / Catatan Tanggapan:
                        </h6>
                        <Input
                          type="textarea"
                          rows="2"
                        ...
                        <Row className="g-2 mt-1">
                          <Col sm="6">
                            <Label className="form-label fs-12px mb-1">Output:</Label>
                            <Input
                              type="select"
                              bsSize="sm"
                          ...
                          <Col sm="6">
                            <Label className="form-label fs-12px mb-1">PIC:</Label>
                            <Input
                              type="text"
                              bsSize="sm"
                      ...
                      <div className="d-flex gap-2 flex-wrap">
                        {["proses", "perlu", "selesai", "batal"].map((st) => (
                          <Button
                            key={st}
                            color={q.status === st ? "primary" : "outline-light"}
                            className={q.status === st ? "" : "text-dark bg-white"}
                            size="sm"
                            onClick={() => {
                              updateQuestion(
                                q.id,
                                {
                                  status: st,
                                  progres: st === "selesai" ? 100 : q.progres,
                                },
                                `Status diubah saat forum: ${st}`
                              );
                            }}
                          >
                            Tandai {st.toUpperCase()}
                          </Button>
                        ))}
                      </div>
                    </div>
            ...
            <div className="d-flex justify-content-between align-items-center p-3 border-top bg-light">
              ...
              <span className="text-muted fs-12px d-none d-sm-inline">
                Gunakan tombol navigasi untuk berpindah antarslide pertanyaan.
              </span>
              <Button
                color="primary"
                size="sm"
        ...
        <div id="print-area-doc" className="d-none d-print-block">
          <div className="text-center mb-4">
            ...
            <h5 className="mb-0">DOKUMEN RISALAH & NOTULA RAPAT RESMI</h5>
            <hr />
          </div>
